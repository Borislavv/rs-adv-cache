...
use advcache::config;
use advcache::liveness;
use advcache::app::App;
...
impl CacheServer {
    ...
    pub async fn start(
        ...
        let probe = liveness::Probe::new(Duration::from_secs(1));
        let app = Arc::new(App::new(shutdown_token.clone(), cfg.clone(), probe).await?);
        
        let graceful_shutdown = Arc::new(advcache::shutdown::GracefulShutdown::new(shutdown_token.clone()));
        ...
        let addr = format!("127.0.0.1:{}", cfg.cache.api.as_ref()
